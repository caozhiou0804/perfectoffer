...
public class ImageLoaderUtil {
    ...
    // SD卡挂载时，图片缓存在sd卡的路径
    public static final String SDCARD_IMG_PATH = Environment.getExternalStorageDirectory().getPath() + "/honghui/images/";

    // SD卡没有挂载时，图片缓存在手机缓存路径
    public static final String CACHE_IMG_PATH = Environment.getDownloadCacheDirectory().getPath() + "/honghui/images/";
