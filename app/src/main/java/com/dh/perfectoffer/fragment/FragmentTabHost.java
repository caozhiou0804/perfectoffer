...
public class FragmentTabHost extends TabHost implements
	...
	public void onTabChanged(String tabId) {
		L.e("yinzl", "currentTab" + getCurrentTabTag());
		int lastPosition = 0;
		if (null != mLastTab) {
			L.e("yinzl", "mLastTab" + mLastTab.tag);
			if (mLastTab.tag.equals(FragmentTabActivity2.TAB_INDEX)) {
				lastPosition = 0;
			} else if (mLastTab.tag.equals(FragmentTabActivity2.TAB_LEIGOU)) {
				lastPosition = 1;
			} else if (mLastTab.tag.equals(FragmentTabActivity2.TAB_MY)) {
				lastPosition = 2;
			} else if (mLastTab.tag.equals(FragmentTabActivity2.TAB_SETTING)) {
				lastPosition = 3;
			}
		}
		if (getCurrentTabTag().equals(FragmentTabActivity2.TAB_MY)) {
