...
import com.dh.perfectoffer.entity.MenuVo;
...
public class ViewPagerFragmentTop extends Fragment {
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
		...
		if (mViewPagerTopBeans != null && len > 0) {
			for (int i = 0; i < len; i++) {
				...
				setImageViewByView(
						(ImageView) item_view.findViewById(R.id.iv_icon),
						R.drawable.default_photo, vo.getPictureLocation());
				...
				item_view
						.setLayoutParams(new LayoutParams(Density
	...
	private void setImageViewByView(ImageView view, int DefaultIconId,
			String IconUrl) {
