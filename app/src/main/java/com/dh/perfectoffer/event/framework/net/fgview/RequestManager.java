package com.dh.perfectoffer.event.framework.net.fgview;

import android.content.Context;

import com.dh.perfectoffer.VehicleApp;
import com.dh.perfectoffer.event.framework.db.AfeiDb;
import com.dh.perfectoffer.event.framework.net.exception.ConnectionException;
import com.dh.perfectoffer.event.framework.net.exception.DataException;
import com.dh.perfectoffer.event.framework.net.exception.RequestParamException;
import com.dh.perfectoffer.event.framework.net.network.NetworkConnection;
import com.dh.perfectoffer.event.framework.net.network.NetworkConnection.ConnectionResult;
import com.dh.perfectoffer.event.framework.net.network.NetworkConnection.Method;
