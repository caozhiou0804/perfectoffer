...
import com.dh.perfectoffer.event.framework.alibaba.fastjson.parser.DefaultJSONParser;
...
import com.dh.perfectoffer.event.framework.alibaba.fastjson.serializer.JSONSerializer;
import com.dh.perfectoffer.event.framework.alibaba.fastjson.serializer.JavaBeanSerializer;
import com.dh.perfectoffer.event.framework.alibaba.fastjson.serializer.SerializeConfig;
import com.dh.perfectoffer.event.framework.alibaba.fastjson.serializer.SerializeWriter;
import com.dh.perfectoffer.event.framework.alibaba.fastjson.serializer.SerializerFeature;
import com.dh.perfectoffer.event.framework.alibaba.fastjson.util.FieldInfo;
import com.dh.perfectoffer.event.framework.alibaba.fastjson.util.IOUtils;
import com.dh.perfectoffer.event.framework.alibaba.fastjson.util.ThreadLocalCache;
import com.dh.perfectoffer.event.framework.alibaba.fastjson.util.TypeUtils;
import com.dh.perfectoffer.event.framework.alibaba.fastjson.util.UTF8Decoder;
...
public abstract class JSON implements JSONStreamAware, JSONAware {
    ...
    static {
        int features = 0;
        features |= com.dh.perfectoffer.event.framework.alibaba.fastjson.serializer.SerializerFeature.QuoteFieldNames.getMask();
        features |= com.dh.perfectoffer.event.framework.alibaba.fastjson.serializer.SerializerFeature.SkipTransientField.getMask();
        features |= com.dh.perfectoffer.event.framework.alibaba.fastjson.serializer.SerializerFeature.SortField.getMask();
    ...
    public static final String toJSONString(Object object, SerializerFeature... features) {
        ...
        try {
            ...
            for (com.dh.perfectoffer.event.framework.alibaba.fastjson.serializer.SerializerFeature feature : features) {
